	...
	public Routenbeschreibung(String[] routenbeschreibung) {
	 ...
	 public String[] erzeugeRoutenbeschreibung(LinkedList<Kante> listeDerKantenAufDerRoute) {
		 ...
		 for (int i=0; i<(s-1); i++) {
			 ...
			 wohin = this.getStringWohin(k.getName(), n.getName()); // abbiegender Straßenverlauf oder abbiegen auf andere Straße
		 ...
		 Routenbeschreibung[0] = String.format("Die Länge der Berechneten Route beträgt: " + this.getStringWieWeit(gesamtEntfernung) + ".");
